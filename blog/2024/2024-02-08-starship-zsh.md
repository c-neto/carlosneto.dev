...
> <i class="fa-solid fa-link"></i> More Details: <i class="fab fa-github"></i> [github.com/ohmyzsh/ohmyzsh/plugins/kubectl](https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/kubectl)
